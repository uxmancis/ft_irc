...
void Commands::handleNAMES(int fd, const std::vector<std::string> &args, PollManager &pollManager)
{
    ...
    if (!targetChannel.empty())
    {
        ...
        {
            std::string err = ":" + hostname + " 366 " + clientNick + " " + targetChannel + " :End of /NAMES list\r\n";
        ...
        std::string namesMsg = ":" + hostname + " 353 " + clientNick + " " + namesLine + "\r\n";
        std::string endMsg = ":" + hostname + " 366 " + clientNick + " " + targetChannel + " :End of /NAMES list\r\n";
    ...
    else
    {
        for (std::map<std::string, Channel>::iterator it = channels.begin(); it != channels.end(); ++it)
        {
            ...
            std::string namesMsg = ":" + hostname + " 353 " + clientNick + " " + namesLine + "\r\n";
            std::string endMsg = ":" + hostname + " 366 " + clientNick + " " + channelName + " :End of /NAMES list\r\n";
